namespace leishen
{
    public static class Lang
    {
        ...
        private static readonly Dictionary<string, Dictionary<string, string>> Translations = new()
        {
            ...
            ["capture_hint"] = new()
            {
                ["en"] = "Click the [Pause] button of Leishen accelerator",
                ["ja"] = "雷神加速器の[一時停止]ボタンをクリック",
                ["ko"] = "雷神加速器의 [일시정지] 버튼을 클릭",
                ["es"] = "Haz clic en el botón [Pausa] de Leishen",
                ["fr"] = "Cliquez sur le bouton [Pause] de Leishen",
                ["de"] = "Klicken Sie auf die [Pause]-Schaltfläche von Leishen",
                ["pt"] = "Clique no botão [Pausar] do Leishen",
                ["ru"] = "Нажмите кнопку [Пауза] в Leishen",
                ["th"] = "คลิกปุ่ม [หยุด] ของ Leishen",
                ["vi"] = "Bấm nút [Tạm dừng] của Leishen",
                ["id"] = "Klik tombol [Jeda] Leishen",
            },
            ["capture_esc"] = new()
            {
                ["en"] = "Press ESC to cancel · Only captures Leishen window",
                ["ja"] = "ESCでキャンセル · 雷神加速器ウィンドウのみ",
                ["ko"] = "ESC 취소 · 雷神加速器 창만 캡처",
                ["es"] = "Presiona ESC para cancelar · Solo captura ventana de Leishen",
                ["fr"] = "Appuyez sur ESC pour annuler · Capture uniquement Leishen",
                ["de"] = "ESC zum Abbrechen · Nur Leishen-Fenster",
                ["pt"] = "Pressione ESC para cancelar · Captura apenas Leishen",
                ["ru"] = "ESC отмена · Только окно Leishen",
                ["th"] = "กด ESC เพื่อยกเลิก · จับเฉพาะหน้าต่าง Leishen",
                ["vi"] = "ESC để hủy · Chỉ chụp cửa sổ Leishen",
                ["id"] = "ESC batal · Hanya tangkap jendela Leishen",
            },
            ["tray_show"] = new()
            {
        ...
        public static readonly Dictionary<string, string> Zh = new()
        {
            ...
            ["capture_hint"] = "点击雷神加速器的【暂停】按钮",
            ["capture_esc"] = "按 ESC 取消 · 仅捕获雷神加速器窗口",
            ["reminder_btn"] = "✓ 知道了",
            ["reminder_time"] = "暂停时间",
        ...
        public static readonly Dictionary<string, string> En = new()
        {
            ...
            ["capture_hint"] = "Click the [Pause] button of Leishen",
            ["capture_esc"] = "Press ESC to cancel · Only captures Leishen",
            ["reminder_btn"] = "✓ Got it",
